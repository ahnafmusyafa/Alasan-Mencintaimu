...
# Tidak perlu import os lagi untuk solusi ini
...
if st.button("Tekan untuk alasan berikutnya ❤️"):
    if st.session_state.data_tersisa:
        ...
        # Kita sekarang membaca file secara manual sebagai data biner
...
try:
    ...
    st.error(f"Error: File lagu '{nama_file_lagu}' tidak ditemukan.")
